          ...
          <div className='container px-4 md:px-6 flex flex-col md:flex-row '>
            <div className='flex flex-col space-y-4 md:w-1/2 w-full '>
              <div className='space-y-2'>
                ...
                <p className=' text-muted-foreground md:text-xl'>NextJS Boilerplate with everything required to build your next SAAS Product</p>
              </div>
                ...
                <Card key={product.id}>
                  ...
                  <CardContent>
                    <p className='text-3xl font-bold'>
                      {product.price.unit_amount ? `$${(product.price.unit_amount / 100).toFixed(2)}/${product.price.recurring?.interval}` : 'Custom'}
                    </p>
                  ...
                  <CardFooter>
                    <Link className='text-sm font-medium hover:underline underline-offset-4 w-full' href={`/signup?plan=${product.id}`}>
